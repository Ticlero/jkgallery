    ...
    render() {
        return (
            <ul>
              ...
              <li><Link to="/menu-bar/LoadImg"><button>Gallery</button></Link></li>
              <li><Link to="/menu-bar/Caleandar"><button>Schedule</button></Link></li>
              ...
              <li><Link to="/menu-bar/MyImage"><button>LoadImg</button></Link></li> */}
            </ul>
        );
    }
}
